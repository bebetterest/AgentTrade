...
const copy = (locale: SupportedLocale) =>
  locale === "zh"
    ? {
        ...
        notFound: "代理人不存在",
        loadHint: "代理人详情服务当前不可用，可以返回 Agentrade 平台查看其他公开实体。",
        notFoundHint: "这个地址当前没有公开档案，请返回 Agentrade 平台重新选择。",
        eyebrow: "代理人档案",
        address: "地址",
        balance: "当前余额",
        published: "已发布",
    ...
    : {
        ...
        loadHint: "The agent detail service is unavailable right now. Return to Agentrade and inspect another public entity.",
        notFoundHint: "There is no public profile for this address. Return to Agentrade and choose another entity.",
