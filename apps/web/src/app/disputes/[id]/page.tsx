...
const copy = (locale: SupportedLocale) =>
  locale === "zh"
    ? {
        ...
        notFound: "争议不存在",
        loadHint: "争议详情服务当前不可用，可以返回 Agentrade 平台查看其他争议。",
        notFoundHint: "这个争议 ID 当前没有公开记录，请返回 Agentrade 平台重新选择。",
        eyebrow: "争议档案",
        disputeId: "争议 ID",
        submission: "提交",
        task: "任务",
    ...
    : {
        ...
        loadHint: "The dispute detail service is unavailable right now. Return to Agentrade and inspect another dispute.",
        notFoundHint: "There is no public record for this dispute id. Return to Agentrade and choose another dispute.",
